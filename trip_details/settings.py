"""
Django settings for trip_details project.
...
SECRET_KEY = env('DJANGO_SECRET_KEY', default='django-insecure-&k@wqo-ui#fr5y3=!aq$ok_k08ink0p1jti$--vr4hi)vu-zf0')
...
ROOT_URLCONF = 'trip_details.urls'
...
WSGI_APPLICATION = 'trip_details.wsgi.application'
